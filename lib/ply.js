...
(function() {
        ...
        function h(a) {
            for (var b = Array.prototype.slice, c = b.call(arguments, 1), d = 0, e = c.length; e > d;

                d++) f(c[d], function(b, c) {
                    a[c] = b
                }
        ...
        function o(a) {
            ...
            return delete a.children, a.tag = d[1] || "div", a.id = a.id || (d[2] || "").substr(1), d = (d[3] || "").split("."), d[0] = a.className || "", a.className = d.join(" "), b = H.createElement(a.tag), delete a.tag, f(a, function(c, d) {
                    ...
                    a && ("string" == typeof a ? a = {
                        ...
                        ), "string" == typeof c && (a.tag = a.tag || c), k(b, o(a)))
                }
        ...
        function q(b) {
            return s(!0), a(function(a) {
                    for (var c, d = j(b, "img"), e = d.length, f = e, g = function() {
                        ...
                        ; e--;
                    ) c = d[e], c.complete ? f-- : (m(c, "load", g), m(c, "error", g));
                    !f && g()
                }
        ...
        function x(a, b) {
            b = a instanceof Object ? a : b || {}

                , b.el = b.el || a;
            var d = this;

            d.cid = "c" + E++, O.zIndex++, d.options = b = h({}

                    , O, b), b.flags = h({}

                    , O.flags, b.flags), v(d, b), d.setEffect(b.effect), d.fx = function(a) {
        ...
        (), L = {
            ...
            , M = "data-ply", N = window.jQuery || window.Zepto || window.ender || window.$, O = {
                clone: !0,
                zIndex: 1e4,
                rootTag: "form",
                baseHtml: !0,
            ...
            , P = window.Promise, Q = window.Deferred || P, R = c();
        ...
        return x.stack = {
            ...
            , x.effects.set({
                ...
                val: function(a, b) {
                    ...
                    ,
                toJSON: function() {
                    for (var a, b = this.el.querySelectorAll("[" + M + "-name]"), c = {}

                            , d = b.length; d--;) a = b[d], c[a.getAttribute(M + "-name")] = this.val(a);
                    return c
                }
            }
            ...
            , x.dialog = function(b, c, d) {
                return b instanceof Object && !z(b) ? (c = c || {}
                    ...
                    , a(function(a, d) {
                            var e, g, i, j = c.initState,
                                ...
                                n = function(a, b, c) {
                                    ...
                                    e = a, i = !0, (a.prepare || F)(d, l), x.create(a.ui || "alert", a.options || {}
                            ...
                            f(k, function(a, b) {
                                    j = j || b, a.effects = a.effects || {}

                                        , a.$name = b, a.$index = o++, l[b] = new x.Context
                                }

                            ), k.$length = o, n(k[j], null, function(b) {
                                    m({}

                                        , b), g.options.onaction = function(b) {
                                        if (i) return !1;
